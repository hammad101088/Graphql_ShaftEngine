...
public class GraphqlApi_base {
    ...
    public static void verifyStatusCode(Response response, String operationName) {
        Verifications.verifyEquals(GraphqlApi_base.SUCCESS_STATUS_CODE,
                RestActions.getResponseJSONValue(response, "data." + operationName + ".code"),
                "verify that status code is: " + GraphqlApi_base.SUCCESS_STATUS_CODE);
    }
    ...
    public static void verifyResponseMessage(Response response, String operationName) {
        ...
        Verifications.verifyEquals(GraphqlApi_base.SUCCESS_MESSAGE,
                RestActions.getResponseJSONValue(response, "data." + operationName + ".message"),
